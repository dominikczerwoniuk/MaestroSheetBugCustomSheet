...
public enum MockCustomActionType {
    case primary, destructive
}

public struct MockCustomActionAttributes {
    let type: MockCustomActionType
    let title: String
    let isLoading: Bool
    let disabled: Bool
    ...
    public init(
        type: MockCustomActionType = .primary,
        title: String,
...
public enum MockCustomActionEmphasis {
    case primary(MockCustomActionAttributes)
    case secondary(MockCustomActionAttributes)
    case tertiary(MockCustomActionAttributes)
...
public struct MockCustomActionSheetContentView: View {
    private let iconSystemName: String?
    private let iconColor: Color
    private let titleText: String?
    private let bodyText: String?
    private let actions: [MockCustomActionEmphasis]

    public init(
        titleText: String?,
        bodyText: String?,
        action1: MockCustomActionEmphasis,
        action2: MockCustomActionEmphasis? = nil,
        action3: MockCustomActionEmphasis? = nil,
        action4: MockCustomActionEmphasis? = nil,
        action5: MockCustomActionEmphasis? = nil
    ) {
...
public enum MockCustomSheetBehavior {
...
struct MockCustomSheet<ContentView: View>: ViewModifier {
    @Binding var isPresented: Bool
    let sheetBehavior: MockCustomSheetBehavior
    let contentBuilder: () -> ContentView
    let onDismiss: (() -> Void)?

    init(
        isPresented: Binding<Bool>,
        sheetBehavior: MockCustomSheetBehavior,
        onDismiss: (() -> Void)? = nil,
...
public extension View {
    /// Shortcut to create a mock CustomSheet that contains a MockCustomActionSheetContentView.
    func mockCustomActionSheet(
        isPresented: Binding<Bool>,
        ...
        self.modifier(
            MockCustomSheet(
                ...
                contentBuilder: {
                    MockCustomActionSheetContentView(
                        titleText: titleText,
                        bodyText: bodyText,
                        action1: action1,
                        action2: action2,
                    ...
                    .accessibilityIdentifier("mockCustomActionSheet")
                }
            )
        )
    }

    /// Shortcut with icon to create a mock CustomSheet.
    func mockCustomActionSheet(
        isPresented: Binding<Bool>,
        dismissable: Bool = false,
        iconSystemName: String,
    ...
    /// Generic sheet with item binding (similar to Custom's implementation).
    func mockCustomActionSheet<ItemType: Identifiable>(
        item: Binding<ItemType?>,
        dismissable: Bool = false,
        contentBuilder: @escaping (ItemType) -> MockCustomActionSheetContentView
    ) -> some View {
